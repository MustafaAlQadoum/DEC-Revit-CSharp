...
namespace CourseAssignments
{
    class Arrays
    {
        //Add new Class to your App named "Arrays" and call the function you want to execute with Console.Read();
        //Arrays.GetArrayInputs();                           //Task 01
        //Arrays.SumArrayValues();                           //Task 02
        //Arrays.GetMaximumAndMinimumValues();               //Task 03
        //Arrays.GetEvenAndOdd();                            //Task 04
        //Arrays.Get3by3ArrayDiagonalSum();                  //Task 05
        //Arrays.GetMinimumValueAndItsIndex();               //Task 06
        //Arrays.GetAdditionOfTwoArrays();                   //Task 07
        //Arrays.GetValuesAndDeleteOne();                    //Task 08
        //Arrays.GetDuplicateValues();                       //Task 09
        //Arrays.GetUniqueValues();                          //Task 10
        // Task 01
        ...
        public static void GetMinimumValueAndItsIndex()
        {
            ...
            Console.WriteLine("The lowest  value in the entered number ={0} \n" +
                              "The Index of this value in the array  =  {1}", minmumValue, minimumValueLocation);
        }
        // Task 10
